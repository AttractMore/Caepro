<?php 
/* Template Name: Sector Category Template */ 
get_header(); 
...
<?php
	...
	<section class="hoverGraphic leadImage">
		...
		<div class="hoverGraphic-panel highway">
		...
		<div class="hoverGraphic-panel commercial">
			<div class="hoverGraphic-panel-content">
		...
		<div class="hoverGraphic-panel automotive">
			<div class="hoverGraphic-panel-content ">
		...
		<div class="hoverGraphic-panel others">
			<div class="hoverGraphic-panel-content">
...
<section class="enquiryForm">
    <div class="l-container" style="flex-direction:column;max-width:950px;">
        <h2 style="color: #ffffff; font-size: 30px; letter-spacing: 4.5px; margin-bottom: 14px ;margin-top:0; ">WANT TO KNOW MORE?</h2>
        <p style="font-size: 32px;line-height:40px; margin-top:0px;   font-family: din-2014,sans-serif;">Please enter your details and a description of your enquiry below and we will be in touch as soon as possible. Thank you for your enquiry.</p>
