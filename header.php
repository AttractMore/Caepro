...
<html <?php language_attributes(); ?> class="no-js">
  ...
  ?>
        ...
        <div class="siteHeader_primary">
          <div class="l-container l-flexContainer">
            ...
            <div class="menuContainer">
              <div class="container">
                <div class="menu">
                  <a href="#mobileNavGroup-main" class="nav_toggle" aria-controls="mobileNavGroup-main" aria-expanded="false"><img src="/wp-content/uploads/2021/11/menu-icon.png"></a>
                  <nav class="menuBar">
                    <?php html5blank_nav(); ?>
                  </nav>
   ...
   ?>
        ...
        <section class="internalBanner am1" style="background:url(<?= $bannerImageUrl ?>); ">
          <div class="l-container">
            <div class="banner-container">
    ...
    <?php if (is_404()): ?>
      ...
      <section class="internalBanner am2" style="background:url(<?= $page_not_found_imageUrl ?>); ">
        <div class="l-container">
          <div class="banner-container">
    ...
    <?php if (
      ...
      (!is_category() &&
        ...
        !is_front_page() &&
        !is_home() &&
        !is_page_template("service-internal-template.php") &&
        !is_page_template("internal-template.php") &&
        !is_page_template("sector-category-template.php") &&
        !is_page_template("service-category-template.php") &&
  ...
  ?>
			...
			<section class="internalBanner am3" style="background:url(<?= $bannerImageUrl ?>); ">
        <div class="l-container">
          <div class="banner-container">
            <h1><?php the_title(); ?></h1>
          </div>
  ...
  ?>
			...
			<section class="internalBanner am4" style="background:url(<?= $bannerImageUrl ?>); ">
        <div class="l-container">
          <div class="banner-container">
 ...
 ?>
    ...
    <section class="internalBanner am5" style="background:url(<?= $bannerImageUrl ?>); ">
      <div class="l-container">
        <div class="banner-container">
          <h1><?= $banner_heading ?></h1>
          <p><?= $banner_content ?></p>
  ...
  <?php if (is_singular("success-stories") && !is_front_page()): ?>
    ...
    ?>
      ...
      <section class="internalBanner am6" style="background:url(<?= $bannerImageUrl ?>); ">
        <div class="l-container">
          <div class="banner-container">
            <h1><?php the_title(); ?></h1>
          </div>
